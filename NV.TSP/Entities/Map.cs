...
namespace TSP.Entities
{
    ...
    public class Map
    {
        ...
        {
            return MathHelper.GetFitness(GetIntersectionAmount(), GetDistance(), Points.Count);
        }
        ...
        public double GetDistance()
        {
            ...
            {
                distance += MathHelper.GetDistance(line);
            }
            return distance;
        }
        ...
        public int GetIntersectionAmount()
        {
            ...
            for (int i = 0; i < Lines.Count; i++)
            {
                ...
                {
                    if (MathHelper.HasIntersection(Lines[i], Lines[k]))
                        intersections++;
                }
            }
