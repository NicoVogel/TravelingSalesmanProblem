...
namespace TSP.Business.Math
{
    ...
    public static class MathHelper : IMathHelper
    {
        ...
        /// <param name="ab"></param>
        /// <returns></returns>
        public static double GetDistance(Line ab)
        {
        ...
        {
            // c = root(a² + b²)
            double a = Math.Pow(x1 - x2, 2);    // a²
            double b = Math.Pow(y1 - y2, 2);    // b²
            return Math.Sqrt(a + b);            // root (a²+b²)
        }
        ...
        /// <param name="cd"></param>
        /// <returns></returns>
        public static bool HasIntersection(Line ab, Line cd)
        {
        ...
        /// <param name="d"></param>
        /// <returns></returns>
        public static bool HasIntersection(Point a, Point b, Point c, Point d)
        {
        ...
        /// <param name="y4"></param>
        /// <returns></returns>
        public static bool HasIntersection(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4)
        {
            // A = (y4 - y3)  
            // B = (x4 - x3)
            //
            ...
            try
            {
                ...
                int Ax = Math.Min(x1, x2);  // linie 1. der kleinere x wert
                int Bx = Math.Max(x1, x2);  // linie 1. der groessere x wert
                int Ay = Math.Min(y1, y2);  // linie 1. der kleinere y wert
                int By = Math.Max(y1, y2);  // linie 1. der groessere y wert
                    
                int Cx = Math.Min(x3, x4);  // linie 2. der kleinere x wert
                int Dx = Math.Max(x3, x4);  // linie 2. der groessere x wert
                int Cy = Math.Min(y3, y4);  // linie 2. der kleinere y wert
                int Dy = Math.Max(y3, y4);  // linie 2. der groessere y wert
        ...
        /// <returns></returns>
        public static int GetFitness(int intersections, double distance, int pointCount)
        {
